...
import ReportTemplateHeader from '../../molecules/ReportTemplate/ReportTemplateHeader';
...
const MissionUsabilityTemplate = ({ dataList, index, register, errors, checked, handleChangeCheckBox, modalControl }) => {
  ...
  return (
    <>
      ...
      {/*{dataList.missionFunctionFatality.map((item, itemIndex) => {*/}
      ...
      {/*              dataValueList={dataList.missionFunctionFatality}*/}
      {/*              name={item.name}*/}
      {/*            />*/}

      {/*            <AnnouncementBox style={{ width: '100%', marginTop: '32px', padding: '12px 16px' }} color={colors.grey._3c} content={item.info} />*/}
      {/*          </FlexBox>*/}
      {/*        </FlexBox>*/}
      {/*      </FlexBox>*/}
