...
export const testMultipleQuestionList = [
  {
    code: 'D(131)N1',
    detailMultipleList: [
      { name: '엠브레인', count: 23, value: 0 },
      { name: '헤이폴', count: 14, value: 0 },
      { name: '패널나우', count: 15, value: 0 },
      { name: '오베이', count: 12, value: 0 },
      { name: '서베이링크', count: 9, value: 0 },
      { name: '갤럽패널', count: 8, value: 0 },
      { name: 'GS&패널', count: 6, value: 0 },
      { name: '두이서베이', count: 1, value: 0 },
      { name: '미띵스', count: 1, value: 0 },
    ],
    count: 123,
    indent: '참여중인 다른 설문',
    name: '질문',
  },
  {
    code: 'D(131)N1',
    detailMultipleList: [
      { name: '엠브레인', count: 23, value: 50 },
      { name: '헤이폴', count: 14, value: 50 },
      { name: '패널나우', count: 15, value: 50 },
      { name: '오베이', count: 12, value: 50 },
      { name: '서베이링크', count: 9, value: 50 },
      { name: '갤럽패널', count: 8, value: 50 },
      { name: 'GS&패널', count: 6, value: 50 },
      { name: '두이서베이', count: 1, value: 50 },
      { name: '미띵스', count: 1, value: 50 },
    ],
    count: 123,
    indent: '참여중인 다른 설문2',
    name: '질문',
  },
  {
    code: 'S(131)N1',
    detailMultipleList: [
      { name: '엠브레인', count: 23, value: 60 },
      { name: '헤이폴', count: 14, value: 60 },
      { name: '패널나우', count: 15, value: 60 },
      { name: '오베이', count: 12, value: 60 },
      { name: '서베이링크', count: 9, value: 60 },
      { name: '갤럽패널', count: 8, value: 60 },
      { name: 'GS&패널', count: 6, value: 60 },
      { name: '두이서베이', count: 1, value: 60 },
      { name: '미띵스', count: 1, value: 60 },
    ],
    count: 123,
    indent: '참여중인 다른 설문3',
    name: '질문',
  },
  {
    code: 'D(131)N1',
    detailMultipleList: [
      { name: '엠브레인', count: 23, value: 70 },
      { name: '헤이폴', count: 14, value: 70 },
      { name: '패널나우', count: 15, value: 70 },
      { name: '오베이', count: 12, value: 70 },
      { name: '서베이링크', count: 9, value: 70 },
      { name: '갤럽패널', count: 8, value: 70 },
      { name: 'GS&패널', count: 6, value: 70 },
      { name: '두이서베이', count: 1, value: 70 },
      { name: '미띵스', count: 1, value: 70 },
    ],
    count: 123,
    indent: '참여중인 다른 설문4',
    name: '질문',
