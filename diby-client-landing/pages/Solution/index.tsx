      ...
      cards: [
        {
          ...
          desc: `Diby 패널은 프로덕트 사용과정에서 느낀 불편사항을 주관식 피드백으로 남깁니다.
응답자의 불편사항 피드백을 미션별로 분류하여,
어떤 기능에서 발생한 불편사항인지 구체적으로 파악할 수 있습니다.
또한 응답자의 피드백을 불편함의 대상, 불편했던 시점,
불편했던 이유와 그 결과를 기준으로 Diby가 자동으로 분석합니다.
가장 언급빈도가 높거나 치명도가 높은 불편사항의
원인과 결과를 파악하실 수 있습니다.
이를 바탕으로 사용성 개선 우선순위를 설정해보세요.
